package bdt.streamdata.producer;
...
import bdt.streamdata.config.TwitterConfiguration;
import bdt.streamdata.model.Tweet;
import bdt.streamdata.producer.callback.BasicCallback;
...
public class TwitterKafkaProducer {
    ...
    public TwitterKafkaProducer() {
        ...
        endpoint.trackTerms(Arrays.asList(TwitterConfiguration.HASHTAG.split(",")));
        
        StatusesFilterEndpoint endpointLocation = new StatusesFilterEndpoint(false)
        		.locations(Arrays.asList(new Location(new Location.Coordinate(19.50139, -161.75583),
    ...
    private Producer<Long, String> getProducer() {
        ...
        properties.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, KafkaConfiguration.KAFKA_BROKERS);
    ...
    public void run() {
        ...
        try (Producer<Long, String> producer = getProducer()) {
            while (true) {
                ...
                if (tweet.getUser() != null && tweet.getUser().getLocation() != null && tweet.getUser().getLocation().contains("USA")) {
